...
userServiceNow = "user"
userPassServiceNow = "@option.svc.ugelastic-p@"
URL = "https://instance.service-now.com/api/now/v1/table/sc_task?sysparm_query=assignment_group=072af48e1b85d1186746eb9fe54bcb4b^companyLIKEUltragaz^state=1&sysparm_limit=500&sysparm_orderby=opened_at"
URL_DEV = "https://instance.service-now.com/api/now/v1/table/sc_task?sysparm_query=assignment_group=c7bcfe7c1b7cfc9078ecda8ee54bcbc7^state=1&sysparm_limit=500&sysparm_orderby=opened_at"
